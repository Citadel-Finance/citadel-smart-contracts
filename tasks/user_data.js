task("user_data", "Get user state of pools")
    .addParam("user_address", "The address of an user")
    .setAction(async function (args, hre, runSuper) {
        ...
        for (i = 0; i < all_pools.length; i++) {
            ...
            let user_staked = await pool.userStaked(args.user_address);
            let available_ctl = await pool.availableCtl(args.user_address);
            console.log(
