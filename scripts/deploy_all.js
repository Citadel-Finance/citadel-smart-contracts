...
async function main() {
 ...
 const outside_token = await OutsideToken.attach("0x3281b72e55D1Dbe9D63395deDeAe0bbE8B4dC6d9");
  //  const outside_token = await OutsideToken.deploy("OUTSIDE", "OUT", 18);
  ...
  const citadel_token = await CitadelToken.deploy(
    ...
    bl_num //process.env.TOKEN_START_BLOCK
  );
  ...
  await citadel_factory.addPool(outside_token.address, parseEther(process.env.POOL_TOKENS_PER_BLOCK), parseEther(process.env.POOL_APY_TAX), parseEther(process.env.POOL_PREMIUM_COEF), true, {gasLimit: 6721975});
  // await citadel_factory.addPool("0x3D5eccb772b6387FB48E0D970bd414D27D2245ef", parseEther(process.env.POOL_TOKENS_PER_BLOCK), parseEther(process.env.POOL_APY_TAX), parseEther(process.env.POOL_PREMIUM_COEF), true, {gasLimit: 6721975});
  // await citadel_factory.addPool("0x4B1308749dD122844A3527704c117c3Cb9d9D30C", parseEther(process.env.POOL_TOKENS_PER_BLOCK), parseEther(process.env.POOL_APY_TAX), parseEther(process.env.POOL_PREMIUM_COEF), false);
  // await citadel_factory.addPool("0x32022d67d5a9Cbc317902EB2E94f255437A46169", parseEther(process.env.POOL_TOKENS_PER_BLOCK), parseEther(process.env.POOL_APY_TAX), parseEther(process.env.POOL_PREMIUM_COEF), false);
